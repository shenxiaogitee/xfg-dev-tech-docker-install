...
其实，上线云服务器非常非常简单，而且云服务器价格也非常非常便宜！趁着618活动月，**28块钱**，都能买一年的云服务器，干嘛不上车！
...
云服务器，就等同于自己的另外一个电脑💻，在另外一台电脑部署 redis、mysql、mq等，本地电脑连接过去使用。

这样有了云服务器，就可以不用嚯嚯本地电脑了，安装了卸，卸了安装，把自己本机电脑环境弄的乱码起糟，全是费时费力的事。

有这精力，不如用一台云服务器部署环境，开发完成项目后，再上线云服务器。既节省本地电脑资源，又锻炼了云服务器操作，起步一举两得！
...
<div align="center">
    <img src="./road-map-docker-install-01.png" width="400px">
</div>
...
- 2c4g 1年（推荐3年），109￥，可部署一套 docker、mysql、redis、rabbitmq、xxl-job、SpringBoot 分布式微服务项目。
...
<div align="center">
    <img src="./road-map-docker-install-02.png" width="650px">
</div>
...
<div align="center">
    <img src="./road-map-docker-install-03.png" width="650px">
</div>
...
<div align="center">
    <img src="./road-map-docker-install-04.png" width="650px">
</div>
...
云服务器处理安装完基础的 Docker 环境外，还需要安装 MySql、Redis、MQ等，这里小傅哥也提供好了相关的教程，可以使用。

<div align="center">
    <img src="./road-map-docker-install-05.png" width="950px">
</div>

- 地址：[https://bugstack.cn/md/road-map/linux.html](https://bugstack.cn/md/road-map/linux.html)
- 说明：进入小傅哥提供的一整套编程路书环境，这里有非常全面的技术栈学习和发布部署操作，你可以按需完成自己的环境搭建。
